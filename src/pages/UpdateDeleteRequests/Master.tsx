...
import { HistoryModal } from "@/pages/UpdateDeleteRequests/HistoryModal";
...
export const UpdateDeleteRequestMaster = () => {
    ...
    const handleSingleAction = async (
        ...
        try {
            ...
            refetch();
            closeConfirm();        // ← close confirm popup only after success
        } catch (error: any) {
            toastError({
                title: "Error",
        ...
        <SlideIn>
            <Stack pl={2} spacing={4}>
                <HStack justify="space-between">
                    <Heading as="h4" size="md" textTransform="capitalize">
                        {formatModelTitle(moduleParam)} Requests
                    </Heading>
                </HStack>
                        ...
                        <HStack spacing={3}>
                            ...
                            <Menu>
                                <MenuButton
                                    ...
                                    textAlign="left"
                                >
                                    {modelOptions.find((o) => o.value === queryParams.model)?.label ?? "Select Model"}
                                </MenuButton>
                                <MenuList>
            ...
            <ConfirmationWithReasonPopup
                ...
                onConfirm={(reason) => {
                    ...
                    // ← removed closeConfirm() from here
                }}
            ...
            {/* ── History Modal (PreviewChangesModal is nested inside) ── */}
            <HistoryModal
...
export default UpdateDeleteRequestMaster;