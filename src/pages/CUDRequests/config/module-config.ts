...
const CUSTOMER_DISPLAY_PROPS: DisplayProp[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { label: 'Account / IBAN No', key: 'ac_iban_no' },
      { label: 'Type of Account', key: 'type_of_ac' },
      { label: 'Swift Code', key: 'swift' },
      { label: 'ABA Routing No', key: 'aba_routing_no' },
  ...
  },
  {
    ...
    key: 'contact_managers',
    showInTable: false,
    rowKey: 'id',
    emptyText: 'No Contact Managers added',
    columns: [
  ...
  },
  {
    ...
    showInTable: false,
    rowKey: 'id',
    emptyText: 'No Shipping Address added',
    columns: [
      { label: 'Attention', key: 'attention' },
  ...
  {
    kind: 'array',
    label: 'Principle of Owners',
    key: 'principle_owners',
    showInTable: false,
    rowKey: 'id',
    emptyText: 'No principle of owners added',
    columns: [
      { label: 'Owner', key: 'owner' },
      { label: 'Phone', key: 'phone' },
      { label: 'Email', key: 'email' },
      { label: 'ID / Passport Copy', key: 'id_passport_copy', renderAs: 'doc' },
      { label: 'Remarks', key: 'remarks' },
    ],
  },
  {
  ...
  },
  {
    ...
    key: 'trader_references',
    showInTable: false,
    rowKey: 'id',
    emptyText: 'No Trader Reference added',
    columns: [
