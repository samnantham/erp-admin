...
export const DownloadSampleOptions = [
  ...
  { label: 'Contact Shipping Addresses', value: 'customer_shipping_addresses' },
  { label: 'Contact Trader References', value: 'customer_trader_references' },
] as const;

export type DownloadSampleKeys = (typeof DownloadSampleOptions)[number]['value'];
...
export const RELATION_TO_SAMPLE_KEY_MAP: Record<RelationType, DownloadSampleKeys> = {
  bank: "customer_banks",
  contact_manager: "customer_contact_managers",
  shipping_address: "customer_shipping_addresses",
  trader_reference: "customer_trader_references",
  principle_of_owner: "customer_principle_owners",
};

export const contactManagementPageConfig: Record<
  DownloadSampleKeys,
  { csv?: string; uploadRoute: string }
> = {
  customer_master: {
